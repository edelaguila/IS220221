...
namespace CapaVistaRRHH
{
    public partial class frmExcepciones : Form
    {
        public frmExcepciones()
        {
			...
			navegador1.ObtenerCamposdeTabla(alias, "excepciones", "hotelSanCarlos");
        ...
        {
			navegador1.CambioEstadoTextbox(txtEstado, rbnEstatusamodulo, "0");
		}
