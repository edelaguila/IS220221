...
{
    public partial class frmExcepto : Form
    {
        ...
        private string tabla3 = "detalle_personalizado_Excepto";
        //Danny Saldaña 0901-18-18686
        public void actualizardatagriew()
        {
            DataTable dt = cn.ExceptollenarTbl(tabla2);
        ...
        public void actualizardatagriewpersonal()
        {
            ...
            DataTable dt = cn.ExceptollenarTblPersonal(tabla2, condicion);
            dataGridView1.DataSource = dt;
        }
        //Danny Saldaña 0901-18-18686
        public void ExceptollenarNombre()
        {
            string condicion = textBox1.Text;
            DataTable dt = cn.ExceptollenarNombre(tabla, condicion);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            cn.Exceptoagregar(tabla3, valor1, valor2);
            actualizardatagriewpersonal();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string valor1 = textBox1.Text;
            string valor2 = textBox3.Text;
            cn.Exceptoeliminar(tabla3, valor1, valor2);
            actualizardatagriewpersonal();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            string condicion = textBox1.Text;
            cn.ExceptoExceptoeliminartodo(tabla3, valor1);
            cn.Exceptoagregartodo(tabla3, valor1, valor2, tabla2);
        }
        ...
        private void textBox1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Enter)
            {
                ...
                ExceptollenarNombre();//llama al evento click del boton
                actualizardatagriewpersonal();
                actualizardatagriew();
                textBox2.Focus();
            }
